...
# Define MDP
mutable struct VerticalCAS_MDP
    hs::Array{Float64,1}
...
POMDPs.actionindex(::VerticalCAS_MDP, a::Int) = a + 1
...
function POMDPs.convert_s(::Type{Float64},V::AbstractVector{Float64}, s::stateType, mdp::VerticalCAS_MDP)
    v = [s[1],s[2],s[3],convert(Float64,s[4]),convert(Float64,s[5])] #,s[6]]
    return v
end

function POMDPs.convert_s(::Type{Float64}, v::AbstractVector{Float64}, mdp::VerticalCAS_MDP)
